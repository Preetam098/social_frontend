                ...
                <div class="text-gray-700">
                  <div class="grid md:grid-cols-2 text-sm">
                    <div class="grid grid-cols-2">
                      ...
                      <div class="px-4 py-2">{profiledata.name}</div>
                    </div>
                    <div class="grid grid-cols-2">
                    ...
                    <div class="grid grid-cols-2">
                      ...
                      <div class="px-4 py-2">{profiledata.phone}</div>
                    </div>
                    ...
                    <div class="grid grid-cols-2">
                      <div class="px-4 py-2 font-semibold">Date Of Birthday</div>
                      <div class="px-4 py-2">{profiledata.dob}</div>
                    </div>
                  </div>
                </div>
