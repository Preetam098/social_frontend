      ...
      <div className="bg-gray-100">
        <div className="container mx-auto my- p-5">
          <div className="md:flex no-wrap md:-mx-2 ">
            ...
            <div className="w-full md:w-5/12 h-full md:my-0 my-2 mx-4">
                ...
                <div className="text-gray-700">
                  <div className="grid text-sm">
                    ...
                    <div className="flex justify-evenly items-center my-1">
                      ...
                      <button className="bg-blue-500 justify-center text-xs sm:text-sm flex items-center  cursor-pointer tracking-wider p-1.5 sm:px-4 rounded text-white font-bold mx-4">
                        <span></span>
                        Post
                      </button>
                ...
                <div className="grid ">
                  <div>
                    <div className="flex items-center space-x-2 font-semibold   mb-2">
                      <img src={Men} className="w-10 rounded-full h-10"></img>
                      <div>
                        <h3 className="m-0 p-0 text-gray-900 ">Surfiya Zakir</h3>
                    ...
                    <div>
                      <p className="text-sm my-2">
                        ...
                        Magnam corrupti voluptate consequuntur perspiciatis
                        explicabo repudiandae temporibus! Molestiae consequuntur
                        repellat optio!
                      </p>
                    </div>
                    <div>
                      <img src={Men} className=""></img>
                    </div>
